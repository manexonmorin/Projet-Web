...
<head>
	...
	<link rel="stylesheet" href="https://use.typekit.net/msd2gid.css">
	<link rel="stylesheet" href="https://use.typekit.net/msd2gid.css">
	<?php wp_head(); ?>
</head>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$timfilp_description = get_bloginfo( 'description', 'display' );
			if ( $timfilp_description || is_customize_preview() ) :
				?>
